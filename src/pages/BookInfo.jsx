...
function BookInfo({ books, addToCart, cart }) {
  // Gain access to the book being used using the useParams built in function
  const { id } = useParams();
              ...
              <div className="book__selected">
                ...
                <div className="book__selected--description">
                  ...
                  <div className="book__selected--price">
                    <Price
                      oPrice={book.originalPrice}
                      sPrice={book.salePrice}
                    />
                  </div>
            ...
            <div className="books">
              {
                ...
                // filters books to recommend to be 5 star rated
              }
            </div>
          </div>
        </div>
